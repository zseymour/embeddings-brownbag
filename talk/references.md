...
| arXiv:2409.14683 (2024-09-23) *Reducing the Footprint of Multi-Vector Retrieval with Minimal Performance Impact via Token Pooling* | Hierarchical 2× pooling applied at index time cuts a complete 2-bit PLAID TREC-COVID index from **760 MB to 388 MB**. The paper reports **1.34% average effectiveness loss** across seven non-outlier BEIR/LoTTE sets; no model retraining or query-time work. Tables 2–3. |
